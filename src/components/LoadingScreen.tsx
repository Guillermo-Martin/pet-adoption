...
function LoadingScreen({ message, imageSrc, alt, error }: LoadingScreenProps) {
  return (
    <div className="loading-container-content">
      <Image src={imageSrc} alt={alt} width={200} height={200} className="w-[40%] xs:w-[60%] lg:w-[80%] max-w-[102.4px] xs:max-w-[163.54px] lg:max-w-[218.06px] mx-auto mb-6 animate-bounce" />
