function Footer() {
  return (
    <div className="footer border-t-[6px] border-t-[#422206] px-4 py-3 md:px-16 md:py-4 xl:px-20">
      <div className="footer-inner-container max-w-7xl mx-auto bg-sky-900">
        <p className="text-center">Made using Next.js, Typescript, React, and TailwindCSS.  Designed in Figma.
